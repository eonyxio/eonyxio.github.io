        ...
        <div data-collapse="medium" data-animation="default" data-duration="400" data-w-id="083b3595-12c0-3eb5-8a08-5d830155c0c6" role="banner" class="navbar w-nav" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
            <div class="w-layout-grid grid-navbar">
                <div data-w-id="083b3595-12c0-3eb5-8a08-5d830155c0c8" class="nav" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                    <a href="`+ "../".repeat(LOC_LEVEL) +`/." aria-current="page" class="brand w-nav-brand w--current" aria-label="home"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/601be3303f11492babdd41e2_logo.svg" loading="lazy" alt="" class="logo hide"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/eonyx.svg" style="height: 46px;" loading="lazy" alt="" class="logo"></a>
                </div>
                <div data-w-id="083b3595-12c0-3eb5-8a08-5d830155c0cb" class="nav nav-links" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                    <nav role="navigation" class="nav-menu w-nav-menu">
                        <a href="`+ "../".repeat(LOC_LEVEL) +`/." aria-current="page" class="nav-link w-nav-link w--current">Home<br></a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`careers" class="nav-link w-nav-link">Careers<br></a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`features" class="nav-link w-nav-link hide">Features<br></a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`contact" class="nav-link w-nav-link">Contact<br></a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`blog" class="nav-link w-nav-link hide">Blog<br></a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`company" class="nav-link w-nav-link hide">Company<br></a>
                    </nav>
                </div>
                <div data-w-id="083b3595-12c0-3eb5-8a08-5d830155c0dc" class="nav right " style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                    <div class="extra-nav-menu hide">
                        <a href="`+ "../".repeat(LOC_LEVEL) +`log-in" class="nav-link w-nav-link">Log in<br></a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`sign-up" class="nav-button w-button">Sign up</a>
                    </div>
    ...
    <div class="section-footer">
        <div class="content">
            <div class="w-layout-grid grid-footer">
                <div id="w-node-da92ec24-0a93-58e4-1a73-58ed5b0e2fba-5b0e2fb7" data-w-id="da92ec24-0a93-58e4-1a73-58ed5b0e2fba" class="block-footer" style="opacity: 0; transform: translate3d(0px, 30px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/601be3303f11492babdd41e2_logo.svg" loading="lazy" alt="" class="logo-footer hide"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/eonyx.svg" style="height: 46px; margin-bottom: 35px;" loading="lazy" alt="" class="logo">
                ...
                <div data-w-id="da92ec24-0a93-58e4-1a73-58ed5b0e2fc6" class="block-footer" style="opacity: 0; transform: translate3d(0px, 30px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                    <div class="heading-footer">Quick Links</div>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`company" aria-current="page" class="link-footer w--current  hide">Company<br></a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`./" class="link-footer ">Home</a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`careers" class="link-footer">Careers</a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`apply" class="link-footer" target="_blank">Apply now</a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`features" class="link-footer hide">Features</a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`contact" class="link-footer">Contact</a>
                        <a href="`+ "../".repeat(LOC_LEVEL) +`blog" class="link-footer  hide">Blog</a>
                    </div>
                ...
                <div data-w-id="da92ec24-0a93-58e4-1a73-58ed5b0e2fde" class="block-footer hide" style="opacity: 0; transform: translate3d(0px, 30px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;">
                    ...
                    <a href="`+ "../".repeat(LOC_LEVEL) +`template-info/instructions" class="link-footer">Instructions</a>
                    <a href="`+ "../".repeat(LOC_LEVEL) +`template-info/licensing" class="link-footer">Licensing<br></a>
                    <a href="`+ "../".repeat(LOC_LEVEL) +`template-info/style-guide" class="link-footer">Style Guide</a>
                    <a href="`+ "../".repeat(LOC_LEVEL) +`template-info/changelog" class="link-footer">Changelog</a>
                </div>
            </div>
    ...
    <div class="section" id="get-started">
        <div class="content">
            ...
            <div class="img-banner">
                <div class="block-app-screen---c"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/6022aa34552161bc2b3fd3da_app%2520screen%25206.svg" loading="lazy" alt="" class="app-screen---c" style="will-change: transform; transform: translate3d(0px, 30px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"></div>
                <div
                    class="block-circle---c-down" style="will-change: transform; transform: translate3d(0px, 80px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle.png" loading="lazy" sizes="(max-width: 479px) 24vw, (max-width: 767px) 25vw, 24vw" srcset="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle-p-500.png 500w, `+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle.png 730w"
                        alt="" class="image-circle---c1" style="will-change: transform; transform: translate3d(-32px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle.png"
                        loading="lazy" sizes="9vw" srcset="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle-p-500.png 500w, eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle.png 730w" alt="" class="image-circle---c2" style="will-change: transform; transform: translate3d(16px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"></div>
            <div
                class="block-circle---c-top" style="will-change: transform; transform: translate3d(0px, 100px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle.png" loading="lazy" sizes="(max-width: 479px) 18vw, 19vw" srcset="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle-p-500.png 500w, `+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle.png 730w"
                    alt="" class="image-circle---c3" style="will-change: transform; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"><img src="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle.png"
                    loading="lazy" sizes="10vw" srcset="`+ "../".repeat(LOC_LEVEL) +`eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle-p-500.png 500w, eonyx_assets/60211e51b1e1bf249435035b_orange%2520circle.png 730w" alt="" class="image-circle---c4" style="will-change: transform; transform: translate3d(32px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg); transform-style: preserve-3d;"></div>
    </div>
    `)
}
